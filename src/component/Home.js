            ...
            <div className="device-mockup iphone6_plus portrait white">
              <div className="device">
                <div className="screen">
                  {/* Demo images for screen mockup, you can put an images here, some HTML, an animation, video, or anything else! */}
                  <img src="https://blackrockdigital.github.io/startbootstrap-new-age/img/demo-screen-1.jpg" className="img-fluid" alt="router" />
                </div>
      ...
      <div className="row">
        <div className="col-md-8 mx-auto">
          ...
          <div className="badges">
            <a className="badge-link" href="#"><img src="img/google-play-badge.svg" alt="router" /></a>
            <a className="badge-link" href="#"><img src="img/app-store-badge.svg" alt="router" /></a>
          </div>
        </div>
      </div>
    </div>
          ...
          <div className="device-container">
            <div className="device-mockup iphone6_plus portrait white">
              <div className="device">
                <div className="screen">
                  {/* Demo images for screen mockup, you can put an images here, some HTML, an animation, video, or anything else! */}
                  <img src="img/demo-screen-1.jpg" className="img-fluid" alt="router" />
                </div>
                <div className="button">
                  {/* You can hook the "home button" to some JavaScript events or just remove it */}
                </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-6">
                <div className="feature-item">
                  ...
                  <h3>Flexible Use</h3>
                  <p className="text-muted">Put an images, video, animation, or anything else in the screen!</p>
                </div>
              </div>
            </div>
            <div className="row">
